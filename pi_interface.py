...
def write_to_disk(sort_type, box1, box2, box3, box4, box5, box6, box7):
    data = open('file.log', 'w+')
    data.write('{};{};{};{};{};{};{};{};'.format(sort_type, box1, box2, box3, box4, box5, box6, box7))
    data.close()
...
def hello():
    ...
    if request.method == 'POST':
        ...
        write_to_disk(sort_type, box1, box2, box3, box4, box5, box6, box7)
